...
from meissonic.scheduler_infer import Scheduler
...
def main():
    ...
    parser.add_argument('--CFG', type=float, default=5, help='Guidance scale (CFG)')
    ...
    if args.model_path != args.base_model_path:
