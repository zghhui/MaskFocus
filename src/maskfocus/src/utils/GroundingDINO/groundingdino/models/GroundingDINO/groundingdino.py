...
from transformers import AutoTokenizer, BertModel, BertTokenizer, RobertaModel, RobertaTokenizerFast, AutoConfig
...
class GroundingDINO(nn.Module):
    ...
    def __init__(
        ...
        # workaround for zero3
        config = AutoConfig.from_pretrained(text_encoder_type)
